...
public class GUI extends JPanel implements ActionListener, ChangeListener, ItemListener {
	...
	public void initialize(Container container) {
        ...
        String[] choices = {"Game of Life", "Rain"};
    ...
    /**
     * dropdown menut to choose simulation option
     * * @see javax.swing.event.ItemListener#stateChanged(javax.swing.event.ItemEvent)
     */
    public void itemStateChanged(ItemEvent e) {
        if (e.getSource().equals(dropdown)) {
            if (dropdown.getSelectedItem().equals("Game of Life")) {
                board.setSimType(SimType.GAME_OF_LIFE);
                board.reinitialize();
            } 
            else if (dropdown.getSelectedItem().equals("Rain")) {
                board.setSimType(SimType.RAIN);
                board.reinitialize();
            }
        }
    }
